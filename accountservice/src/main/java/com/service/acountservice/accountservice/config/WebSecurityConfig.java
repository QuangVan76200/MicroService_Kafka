...
import com.service.acountservice.accountservice.security.support.ServerHttpBearerAuthenticationConverter;
import com.service.acountservice.accountservice.security.support.ServerHttpCookieAuthenticationConverter;
        ...
        return http
                .authorizeExchange()
                    ...
                    .pathMatchers(publicRoutes)
                        .permitAll()
                        .pathMatchers("/api/auth/profiles/sign-up", "/api/auth/account/login")
                        .permitAll()
                        .pathMatchers("/api/auth/account/**").permitAll()
                    .anyExchange()
                        .authenticated()
                    .and()
                .csrf()
